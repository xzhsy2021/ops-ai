...
def _safe_ctx_payload(ctx: ToolContext) -> Dict[str, Any]:
    ...
    return {
        ...
        "channel_bindings": payload.get("channel_bindings") or [],
        "approver_identities": payload.get("approver_identities") or [],
        "bound_room_ids": payload.get("bound_room_ids") or [],
        "approver_matrix_ids": payload.get("approver_matrix_ids") or [],
