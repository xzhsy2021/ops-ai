...
def test_temporary_approval_grants_table_and_indexes_are_migrated_once():
    ...
    assert {
        ...
        "confirmation_expires_at", "confirmation_consumed_at", "revoked_by_actor_key",
    ...
    assert {"ix_temporary_grant_status", "ix_temporary_grant_expires", "ix_temporary_grant_beneficiary"} <= indexes
